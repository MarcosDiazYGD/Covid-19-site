...
const Home = () => {
  ...
  return (
    <>
      <Header
      video={video1}
        title={'consult the information regarding covid 19 in different countries'}
        description={`The information shared on this website comes from the COVID TRACKING public API`} />
